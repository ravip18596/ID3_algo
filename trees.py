...
def createDataSet():
    dataSet = [[1, 1, 0, 1, 2, 'self'],
               ...
               [3, 1, 2, 3, 3, 'self'],
               [3, 2, 4, 4, 3, 'non-self'],]
    labels = ['Process ID', 'File Size', 'Memory Peak Usage','Page Faults','Page File Peak Usage']
...
answer = classify(mytree, ['Process ID', 'File Size', 'Memory Peak Usage','Page Faults','Page File Peak Usage'], [3, 2, 2, 2, 2])
print("Hi, the answer is "+ answer + ", it is self process")

# test with cartoon characters winter pictures
answer = classify(mytree, ['Process ID', 'File Size', 'Memory Peak Usage','Page Faults','Page File Peak Usage'], [2, 2, 0, 0, 1])
print("Hi, the answer is "+ answer + ", it is not self process")
